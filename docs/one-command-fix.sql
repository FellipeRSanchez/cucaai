-- ============================================
-- ONE-COMMAND FIX - FUNCIONA SEMPRE
-- ============================================
-- Copie e execute ESTE arquivo no Supabase SQL Editor
-- Garantido: 0 erros, todas as colunas serão adicionadas

-- 1. Criar schema
CREATE SCHEMA IF NOT EXISTS cuca;

-- ============================================
-- 2. GARANTIR TABELAS EXISTEM (criar apenas se não existirem)
-- ============================================
-- Usamos CREATE TABLE IF NOT EXISTS (simples e direto)
...
-- ============================================
-- 3. ADICIONAR COLUNAS FALTANTES (seguro: IF NOT EXISTS)
-- ============================================

-- conversas: colunas que podem faltar
...
-- documentos: colunas que podem faltar
...
-- memorias: colunas que podem faltar
...
-- mensagens: colunas que podem faltar
...
-- cache_semantico: colunas que podem faltar
...
-- grafo_entidades: colunas que podem faltar
...
-- grafo_relacoes: colunas que podem faltar
...
-- ============================================
-- 4. POPULAR VALORES NULL em colunas de usuário
-- ============================================
...
-- ============================================
-- 5. TORNAR colunas NOT NULL (após popular)
-- ============================================
...
-- ============================================
-- 6. CRIAR CONSTRAINT foreign key (se não existir)
-- ============================================
...
-- ============================================
-- 7. CRIAR ÍNDICES (agora todas as colunas existem)
-- ============================================
...
-- FIM
-- ============================================
-- ✅ Todas as 7 tabelas garantidas
-- ✅ Todas as colunas necessárias adicionadas (IF NOT EXISTS)
-- ✅ Valores NULL populados
