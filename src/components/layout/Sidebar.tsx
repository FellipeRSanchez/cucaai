...
import { MessageCircle, Brain, Database, Network, Search, PlusCircle, Settings, UserCircle, Menu, Trash2, History } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 h-full bg-zinc-900 border-r border-zinc-800 flex flex-col hidden md:flex shrink-0">
      <div className="p-4 flex items-center justify-between border-b border-zinc-800">
        <h1 
          className="font-bold text-lg tracking-tight bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent cursor-pointer" 
