-- ============================================
-- FIX SIMPLES E GARANTIDO PARA O SCHEMA CUCA
-- ============================================
-- Execute este arquio no Supabase SQL Editor
-- É 100% seguro executar múltiplas vezes
...
-- ============================================
-- 2. ADICIONAR COLUNAS FALTANTES (se tabelas já existem)
-- ============================================

-- conversas: adicionar con_usuario_id se faltar
DO $$ 
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns 
    WHERE table_schema = 'cuca' AND table_name = 'conversas' AND column_name = 'con_usuario_id'
  ) THEN
    ALTER TABLE cuca.conversas ADD COLUMN con_usuario_id UUID;
...
-- documentos: adicionar colunas faltantes
DO $$ 
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'cuca' AND table_name = 'documentos') THEN
...
-- memorias: adicionar colunas faltantes
DO $$ 
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'cuca' AND table_name = 'memorias') THEN
...
-- mensagens: adicionar colunas faltantes
DO $$ 
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'cuca' AND table_name = 'mensagens') THEN
...
-- ============================================
-- 3. CRIAR CONSTRAINT FOREIGN KEY (se não existir)
-- ============================================
DO $$ 
BEGIN
  IF NOT EXISTS (
...
-- ============================================
-- 4. CRIAR ÍNDICES (após tabelas e colunas existirem)
-- ============================================
...
-- ✅ Todas as colunas necessárias garantidas
